...
For the server, we use \textbf{squire.Networking.Server} as the entry class, and \textbf{squire.Main} for the client. Then, we create a basic squire.db file using IntelliJ's built in SQLite capabilities using the generated sqlite-create-all.sql script.
