...
%\includegraphics[width=\textwidth]{images/UseCases/Authentication}

\newpage

\subsubsection[Authentication Feature 1: Use Case 1]{\selectlanguage{english}\rmfamily\bfseries\color{black}
...
\subsubsection[Authentication Feature 2: Use Case Description 2]{\selectlanguage{english}\rmfamily\bfseries\color{black}
...
\subsubsection[Project Browsing Feature 1: Use Case Description 1]{\selectlanguage{english}\rmfamily\bfseries\color{black}
...
\subsubsection[Communication Feature 1: Use Case Description 1]{\selectlanguage{english}\rmfamily\bfseries\color{black}
...
\subsubsection[Communication Feature 2: Use Case Description 2]{\selectlanguage{english}\rmfamily\bfseries\color{black}
...
\subsubsection[Use Case Diagram 5: Project Management]{\selectlanguage{english}\rmfamily\bfseries\color{black}
...
\subsubsection[Project Management Feature 1: Use Case Description 1]{\selectlanguage{english}\rmfamily\bfseries\color{black}
...
\subsubsection[Project Management Feature 2: Use Case Description 2]{\selectlanguage{english}\rmfamily\bfseries\color{black}
...
\subsubsection[File Editing Feature 1: Use Case Description 1]{\selectlanguage{english}\rmfamily\bfseries\color{black}
...
\subsubsection[File Editing Feature 2: Use Case Description 2]{\selectlanguage{english}\rmfamily\bfseries\color{black}
...
\subsubsection[File Management Feature 1: Use Case Description 1]{\selectlanguage{english}\rmfamily\bfseries\color{black}
...
\subsubsection[File Management Feature 2: Use Case Description 2]{\selectlanguage{english}\rmfamily\bfseries\color{black}
...
\subsubsection[Project User Management Feature 1: Use Case Description 1]{\selectlanguage{english}\rmfamily\bfseries\color{black}
...
\subsubsection[Project User Management Feature 2: Use Case Description 2]{\selectlanguage{english}\rmfamily\bfseries\color{black}
...
\end{itemize}
\newpage
\subsubsection[Class Diagram 4: Authentication]{\selectlanguage{english}\rmfamily\bfseries\color{black}
...
\subsubsection[Class Diagram Description 4: Authentication Description]{\selectlanguage{english}\rmfamily\bfseries\color{black}
...
\subsubsection[Class Diagram 5: User Preferences]{\selectlanguage{english}\rmfamily\bfseries\color{black}
	Class Diagram 5: User Preferences}
\hypertarget{RefHeading22059017292}{}
\bigskip
...
\subsubsection[Class Diagram Description 5: User Preferences Description]{\selectlanguage{english}\rmfamily\bfseries\color{black}
	Class Diagram Description 5: User Preferences Description}
\hypertarget{RefHeading22059017292}{}
...
\newpage
\subsubsection[Class Diagram 6: Communication]{\selectlanguage{english}\rmfamily\bfseries\color{black}
	Class Diagram 6: Communication}
\hypertarget{RefHeading22059017292}{}
\bigskip
...
\newpage
\subsubsection[Class Diagram Description 6: Communication Description]{\selectlanguage{english}\rmfamily\bfseries\color{black}
	Class Diagram Description 6: Communication Description}
\hypertarget{RefHeading22059017292}{}
...
\subsubsection[Class Diagram 7: Project Browsing]{\selectlanguage{english}\rmfamily\bfseries\color{black}
	Class Diagram 7: Project Browsing}
\hypertarget{RefHeading22059017292}{}
\bigskip
...
\subsubsection[Class Diagram Description 7: Project Browsing]{\selectlanguage{english}\rmfamily\bfseries\color{black}
	Class Diagram Description 7: Project Browsing}
\hypertarget{RefHeading22059017292}{}
